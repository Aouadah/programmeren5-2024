...
@section('content')
    ...
    <h1 class="ml-6 mb-4">Create Movie</h1>
    <form method="POST" action="/movies" enctype="multipart/form-data" class="w-7/12 mx-auto">
        @csrf
        <div class="flex justify-between">
            <div>
                <div class="flex flex-col mb-4 w-96">
                    <label for="title">Title:</label>
                    <input type="text" id="title" name="title" value="{{ old('title') }}" class="border border-gray-300 p-2 rounded">
                    @error('title')
                ...
                <div class="flex flex-col mb-4 w-96">
                    ...
                    <input type="number" id="year_of_release" name="year_of_release" min="1900" max="2024" value="{{ old('year_of_release') }}" class="border border-gray-300 p-2 rounded">
            ...
            <div>
                <div class="flex flex-col mb-4 w-96">
                    ...
                    <input type="number" id="rating" name="rating" min="1" max="10" value="{{ old('rating') }}" class="border border-gray-300 p-2 rounded">
                    @error('rating')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
